  ...
  overrides: [
    {
      ...
      rules: {
        ...
        '@typescript-eslint/no-shadow': ['error', { ...noShadowOptions, allow: ['URL', 'URLSearchParams'] }],
        ...
        '@typescript-eslint/restrict-template-expressions': ['error', { allowAny: true, allowBoolean: true, allowNumber: true }],
